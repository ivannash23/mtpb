...
class TripPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trip_plan" do
    assert_difference('TripPlan.count') do
      post trip_plans_url, params: { trip_plan: { summary: @trip_plan.summary, title: @trip_plan.title } }
    end
  ...
  test "should update trip_plan" do
    patch trip_plan_url(@trip_plan), params: { trip_plan: { summary: @trip_plan.summary, title: @trip_plan.title } }
